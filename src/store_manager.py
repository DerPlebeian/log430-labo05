...
def get_order_id(order_id):
    ...
    with tracer.start_as_current_span("store_manager.get_order_id"):
        return get_order(order_id)

@app.get('/products/<int:product_id>')
def get_product_id(product_id):
    """Get product with a given product_id"""
    with tracer.start_as_current_span("store_manager.get_product_id"):
        return get_product(product_id)

@app.get('/users/<int:user_id>')
def get_user_id(user_id):
    """Get user with a given user_id"""
    with tracer.start_as_current_span("store_manager.get_user_id"):
        return get_user(user_id)

@app.get('/stocks/<int:product_id>')
def get_stocks(product_id):
    """Get product stocks by product_id"""
    with tracer.start_as_current_span("store_manager.get_stocks"):
...
def get_orders_highest_spending_users():
    ...
    with tracer.start_as_current_span("store_manager.get_orders_highest_spending_users"):
...
def get_orders_report_best_selling_products():
    ...
    with tracer.start_as_current_span("store_manager.get_orders_report_best_selling_products"):
...
def get_stocks_overview():
    ...
    with tracer.start_as_current_span("store_manager.get_stocks_overview"):
...
def graphql_supplier():
    with tracer.start_as_current_span("store_manager.graphql_supplier"):
...
def put_orders():
    ...
    with tracer.start_as_current_span("store_manager.put_orders"):
